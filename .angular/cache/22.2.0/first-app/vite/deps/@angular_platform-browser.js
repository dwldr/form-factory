import { $i as unwrapSafeValue, $l as __awaiter, $r as findLocaleData, Ac as InjectionToken, Ar as _sanitizeUrl, Bn as LOCALE_ID, Bo as ɵɵinjectAttribute, Br as bypassSanitizationTrustUrl, Bt as computed, Cc as ErrorHandler, Cr as TracingService, Dn as Host, Dr as ViewEncapsulation, Ec as IMAGE_CONFIG_DEFAULTS, Ei as performanceMarkFeature, El as signal, En as ElementRef, Er as ViewContainerRef, F as createPlatformFactory, Fl as ɵɵinject, Fn as Injectable, Gl as operate, Hc as PLATFORM_INITIALIZER, Hl as map, Hs as ɵɵstyleProp, In as Input, Ir as bypassSanitizationTrustHtml, Jc as SecurityContext, Jl as reportUnhandledError, Jr as createNgModule, Ki as setDocument, Kl as Observable, Lr as bypassSanitizationTrustResourceUrl, Lt as ResourceImpl, Ml as ɵɵdefineInjector, Nr as allLeavingAnimations, O as booleanAttribute, Oc as INJECTOR_SCOPE, Ol as stringify, Pn as Inject, Pr as allowSanitizationBypassAndThrow, Pt as CACHE_ACTIVE, Ql as __await, Qn as Optional, Rr as bypassSanitizationTrustScript, Sc as EnvironmentInjector, Tc as IMAGE_CONFIG, Tr as USE_PENDING_TASKS, Ul as Subject, Vc as PLATFORM_ID, Vn as LocaleDataIndex, Vt as encapsulateResourceError, Wc as PendingTasks, Wi as setClassMetadata, Wl as createOperatorSubscriber, Wt as linkedSignal, Xl as __asyncGenerator, Xr as describeDomNode, Yc as TransferState, Yl as isFunction, Yt as APP_BOOTSTRAP_LISTENER, Z as internalCreateApplication, Zc as Version, Zl as __asyncValues, Zn as NgModuleRef$1, ao as ɵɵdefineNgModule, ar as RendererFactory2, au as _objectSpread2, bc as ENVIRONMENT_INITIALIZER, bi as isSubscribable, br as TestabilityRegistry, bt as withI18nSupport$1, co as ɵɵdirectiveInject, dr as Service, el as _global, er as Pipe, eu as __generator, fc as _asyncToGenerator, fi as getLocalePluralCase$1, fl as inject, fn as Console, gc as CSP_NONCE, hl as isSignal, hr as TESTABILITY_GETTER, io as ɵɵdefineDirective, ir as Renderer2, jc as Injector, jl as ɵɵdefineInjectable, jn as IS_ENABLED_BLOCKING_INITIAL_NAVIGATION, jo as ɵɵgetInheritedFactory, kc as INTERNAL_APPLICATION_ERROR_HANDLER, kl as truncateMiddle, kr as _sanitizeHtml, la as ɵɵNgOnChangesFeature, m as KeyValueDiffers, mc as APP_ID, mn as DEFAULT_CURRENCY_CODE, mr as TESTABILITY, nn as Attribute, ol as formatRuntimeError, oo as ɵɵdefinePipe, or as RendererStyleFlags2, ot as platformCore, ou as _defineProperty, p as IterableDiffers, qc as RuntimeError, ql as observable, qn as NgModule, qt as untracked, r as ChangeDetectorRef, rt as numberAttribute, sl as forwardRef, so as ɵɵdefineService, sr as SHARED_STYLES_HOST, t as ApplicationModule, tl as assertInInjectionContext, tn as ApplicationRef, tu as __values, ut as provideStabilityDebugging, vc as DOCUMENT, vl as makeEnvironmentProviders, vr as TemplateRef, vt as withDomHydration, wl as runInInjectionContext, wn as Directive, xt as withIncrementalHydration$1, yc as DestroyRef, yi as isPromise$1, yl as makeStateKey, yr as Testability, yt as withEventReplay$1, zc as NgZone, zr as bypassSanitizationTrustStyle } from "./core-BhdS74PP.js";
...
_defineProperty(NgLocalization, "ɵprov", /*@__PURE__*/ ɵɵdefineService({
	...
	factory: () => {
		return (() => {
			return new NgLocaleLocalization(inject(LOCALE_ID));
		})();
	}
}));
(() => {
...
function _bootstrapApplication() {
	_bootstrapApplication = _asyncToGenerator(function* (rootComponent, options, context) {
		const config = _objectSpread2({ rootComponent }, createProvidersConfig(options, context));
		...
		const getInitialStream = (req) => {
			if (cacheOptions && transferState && req) {
				...
				if (cachedResponse) try {
					...
					const parsed = (options === null || options === void 0 ? void 0 : options.parse) ? options.parse(body) : body;
