...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives, allowNonStandaloneDirectives) {
  const tAttributes = rootSelectorOrNode ? ['ng-version', '22.2.0'] : extractAttrsAndClassesFromSelector(componentDef.selectors[0]);
...
function getBaseDocUrl() {
  ...
  const isPreRelease = full.includes('-next') || full.includes('-rc') || full === '22.2.0';
